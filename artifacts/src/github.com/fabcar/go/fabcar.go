package main
 ...
 import (
	 ...
	 "github.com/hyperledger/fabric-chaincode-go/shim" // this is not available in the go repository and we have to use third party vendoring dependencies managnent tool
